...
void loop() {
  ...
  if (deviceConnected) {
    if(M5.BtnB.wasPressed()) {
      ...
      M5.Lcd.printf("The temperature is %d degrees celcius\n", temperature);
      pCharacteristic->setValue("Button B pressed!"); // set the value of the characteristic so that the gateway can read the value
